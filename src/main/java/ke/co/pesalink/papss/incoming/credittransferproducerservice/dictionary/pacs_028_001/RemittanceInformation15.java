 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Ustrd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.028.001.02}Max140Text" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Strd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.028.001.02}StructuredRemittanceInformation15" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable
{
    ...
    protected List<StructuredRemittanceInformation15> strds;
     ...
     * 
     */
    public List<StructuredRemittanceInformation15> getStrds() {
        if (strds == null) {
            strds = new ArrayList<StructuredRemittanceInformation15>();
        }
        return this.strds;
    }
